...
export default function SideBar() {
  ...
  return (
    <div className={dark ? "dark" : ""}>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full bg-white dark:bg-gray-800 shadow-lg pt-20 transition-all duration-300 overflow-y-auto z-40 ${sidebarOpen ? "w-64" : "w-16"
          }`}
      >
        <ul className="space-y-2 px-3">
          ...
          <li>
            ...
            <Link
              href="/sale"
              className={`flex items-center px-3 py-2 rounded-md hover:bg-blue-500 hover:text-white ${pathname === "/sale"
         ...
         <li>
            <Link
              href="/sale"
              className={`flex items-center px-3 py-2 rounded-md hover:bg-blue-500 hover:text-white ${pathname === "/item_details"
                  ? "bg-blue-500 text-white"
                  : "text-gray-600 dark:text-gray-200"
                }`}
            >
